    ...
    for (const [index, mimic_item] of data.entries()){
        ...
        for (let obj of objs){
            ...
            command = {
                ...
                easing: mimic_item['easing'] ? mimic_item[easing] : 'linear',
                // Callback runs before movement begins.
...
function run_mimic(data){
    ...
    left_eye_timeline.remove('#left-eye')
    right_eye_timeline.remove('#right-eye')
    mouth_timeline.remove('#mouth')
    ...
    left_eye_timeline.restart()
    right_eye_timeline.restart()
    mouth_timeline.restart()
